...
namespace seneca
{
    ...
    // Specialization for Book with capacity 72
    ...
    Book
        Collection<Book, 72>::m_smallestItem = Book("", 1, 10000);
    Book
        Collection<Book, 72>::m_largestItem = Book("", 10000, 1);
